...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Doormat`.`Agente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Doormat`.`CalificacionesAgente` ;

CREATE TABLE IF NOT EXISTS `Doormat`.`CalificacionesAgente` (
  `calificacionesAgenteId` INT NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Doormat`.`CalificacionesPropiedad` ;

CREATE TABLE IF NOT EXISTS `Doormat`.`CalificacionesPropiedad` (
  `calificaciónPropiedadId` INT NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Doormat`.`Cliente` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Doormat`.`Propiedad` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Doormat`.`Visita` ;
