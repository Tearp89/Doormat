...
public class Propiedad {
    ...
    private int noEstancias;
    private int noBanios;
    private int cochera;
    private int tamanio;
    ...
    public int getNoEstancias() {
        return noEstancias;
    }
    public void setNoEstancias(int noEstancias) {
        this.noEstancias = noEstancias;
    }
